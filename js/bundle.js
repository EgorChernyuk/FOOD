...
function forms(formSelector, modalTimerId) {
    ...
    function showThanksModal(message) {
        ...
        setTimeout(() => {
            ...
            (0,_modals__WEBPACK_IMPORTED_MODULE_0__.closeModal)('./modals');
        }, 4000);
    }
}
...
function sliders({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    function showDotInSlider (arrDots) {
    ...
    function flippingSlide () {
        slidesField.style.transform = `translateX(-${offset}px)`;
    };

    function delSymbolInStrig (str) {
        return +str.replace(/\D/g, '');
    }


    next.addEventListener('click', () => {
        if (offset == delSymbolInStrig(width) * (slides.length - 1)) {
            offset = 0;
        }else {
            offset += delSymbolInStrig(width);
        }
        ...
        flippingSlide ();
        slideCurrent();
        showDotInSlider(dots);
    });

    prev.addEventListener('click', () => {
        if ( offset == 0) {
            offset = delSymbolInStrig(width) * (slides.length - 1);
        }else {
            offset -= delSymbolInStrig(width);
        }
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = delSymbolInStrig(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modals__WEBPACK_IMPORTED_MODULE_3__.openModal)('./modals', modalTimerId), 300000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2023-09-12');
